...
func TestSese(t *testing.T) {
	client1 := NewClient("https://sese-detect.cognitiveservices.azure.com", "76f80c707b2c4e2fb08359d58b54fbb7", ContentModeratorPath)
...
func TestOcr(t *testing.T) {
	as := require.New(t)
	client1 := NewClient("https://bot-cv.cognitiveservices.azure.com", "309854db85b14b8081fb32e1ee608965", OcrPath)
